		...
		let websites = [
			{
				...
				desc:"This was using the unsplash API to look up images by keyword and giving the user the option to save and image as a favorite. It was nice to integrate a database with a website, while this was something that I had experience with before I had not done it with node.js, all of my previous server side coding experience was with PHP in the past.",
			...
			},
			{
				...
				desc:"Tasked with the task of making a site that has user intractable elements I couldn't think of a better option but to make a game. I found this really fun to see how much I could make quickly, as we were required to make a website that used user interaction, while the expectation of the assignment was to make a quiz or something similar I decided to make a basic game.",
