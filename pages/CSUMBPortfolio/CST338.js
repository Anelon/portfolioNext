							...
							<div>
								...
								<div class="grid-x grid-margin-x">
									<div className="cell medium-6 large-6" >
										<p>
											I wanted to make something similar to a project that I find is a really good connection of a lot of the introductory parts of a language, Pokemon, a very very simplified version of pokemon. This requires the user to select two Pokemon, then 4 moves for each Pokemon. This gives a really good idea for how file input and output works as well as classes and inheritance as it requires at least 3 classes with the base Pokemon class that holds all of the base stats. A Move class which holds all of the move stats and name. Finally a UserPokemon class that inherits from Pokemon and adds a vector of 4 moves and adds a current health (could be expanded to hold current stats.
										</p>
						...
						<div label="Text Slot Game">
							<div>
								...
								<div class="grid-x grid-margin-x">
									<div className="cell medium-6 large-6" >
										<p>
											This was an interesting but not that challenging project. We were tasked with making a simple slot game as a way of randomizing strings based on simple percentages. The video included shows much of the approach took but it was. One of the weird spots I ran into while working on this assignment was the strange stats compared to what should be expected from a slot game (giving the user way too many chances of winning).
										</p>
